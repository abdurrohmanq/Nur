...
public interface ICartItemService
{
    ...
    public Task<bool> DeleteAllAsync(long cartId, CancellationToken cancellationToken);
    ...
    public Task<CartItemResultDTO> GetByProductIdAsync(long productId, CancellationToken cancellationToken);
